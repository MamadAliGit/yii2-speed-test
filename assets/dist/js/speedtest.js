...
function Speedtest() {
  ...
  this._settings = {
    url_dl: dl_action_url , // path to a large file or garbage.php, used for download test. must be relative to this js file
    url_ul: get_ping_url, // path to an empty file, used for upload test. must be relative to this js file
    url_ping: get_ping_url, // path to an empty file, used for ping test. must be relative to this js file
    url_getIp: get_ip_url, // path to getIP.php relative to this js file, or a similar thing that outputs the client's ip
    url_telemetry: get_save_data_url, // path to the script that adds telemetry data to the database
...
Speedtest.prototype = {
  ...
  start: function() {
    ...
    this.worker = new Worker(speedtest_worker_url + Math.random());
